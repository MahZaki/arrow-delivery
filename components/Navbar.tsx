...
import { Menu, X, Box, MapPin, DollarSign, LogIn } from 'lucide-react';
        ...
        <div className="flex items-center justify-between h-28">
          ...
          <div className="flex-shrink-0 flex items-center gap-3 cursor-pointer" onClick={() => navigate('/')}>
             <img 
               ...
               className="h-20 md:h-24 w-auto object-contain drop-shadow-[0_0_15px_rgba(47,191,142,0.6)]"
             />
          </div>
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-4">
              ...
              {isAuthenticated && (
                <span className="text-arrow-gray/50 text-sm italic">— menu in sidebar</span>
              )}
            </div>
          </div>
